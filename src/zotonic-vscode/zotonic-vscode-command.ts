import { ExtensionContext, commands, SnippetString, window } from "vscode";
import { ICommand, ISnippetCommandCallback } from "../zotonic/core";
import { RegisterTplCommand, TplCommandName, VSCodeCommandName, TplCommandArgs, TplCommandReturn, TplCommandFunction, TextEditorCommandCallback, CommandKind, CommandInterpreterCallback, TplCommandInterpreter } from "./core";
